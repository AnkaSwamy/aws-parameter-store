...
variable "params" {
  default= [
    ...
    { name = "roboshop.dev.redis_host", value = "http://redis-dev.ankadevopsb73.store:8080/", type = "String" },
    { name = "roboshop.dev.catalogue_host", value = "http://catalogue-dev.ankadevopsb73.store:8080//", type = "String" },
    { name = "roboshop.dev.catalogue_port", value = "8080", type = "String" },
